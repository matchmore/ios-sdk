...
//        beacons.append(DeviceBis.init(pinName: "pin1", location: CLLocation.init(latitude: CLLocationDegrees(46.522076), longitude: CLLocationDegrees(6.583502))))
        beacons.append(PBeaconDevice.init(name: "beacon1 - rose", uuid: UUID.init(uuidString: "B9407F30-F5F8-466E-AFF9-25556B57FE6D")!, major: 21978, minor: 59907))
        beacons.append(PBeaconDevice.init(name: "beacon2 - jaune canari", uuid: UUID.init(uuidString: "B9407F30-F5F8-466E-AFF9-25556B57FE6D")!, major: 64575, minor: 19467))
        beacons.append(PBeaconDevice.init(name: "beacon3 - bordeau-betrave", uuid: UUID.init(uuidString: "B9407F30-F5F8-466E-AFF9-25556B57FE6D")!, major: 53494, minor: 28090))
        print("DUMMY Beacons ready.")
    }
    
    public func getBeacons() -> [PBeaconDevice]{
        return beacons
    }
}
